...
--  stable, OFF if not).
   ...
   type RCC_CR_Register is record
      ...
      HSION          : RCC_CR_HSION_Field := STM32_SVD.RCC.B_0x0;
      ...
      HSIKERON       : RCC_CR_HSIKERON_Field := STM32_SVD.RCC.B_0x0;
      ...
      HSIRDY         : RCC_CR_HSIRDY_Field := STM32_SVD.RCC.B_0x0;
      --  unspecified
      ...
      --  This bit cannot be reset if the HSE oscillator is used directly or
      --  indirectly as the system clock.
      HSEON          : RCC_CR_HSEON_Field := STM32_SVD.RCC.B_0x0;
      ...
      HSERDY         : RCC_CR_HSERDY_Field := STM32_SVD.RCC.B_0x0;
      ...
      HSEBYP         : RCC_CR_HSEBYP_Field := STM32_SVD.RCC.B_0x0;
      --  Clock security system enable Set by software to enable the clock
      --  security system. When CSSON is set, the clock detector is enabled by
      ...
      --  cleared by reset.
      CSSON          : RCC_CR_CSSON_Field := STM32_SVD.RCC.B_0x0;
      --  unspecified
      ...
      --  clock.
      PLLON          : RCC_CR_PLLON_Field := STM32_SVD.RCC.B_0x0;
      --  Read-only. Main PLL clock ready flag Set by hardware to indicate that
      --  the main PLL is locked.
      PLLRDY         : RCC_CR_PLLRDY_Field := STM32_SVD.RCC.B_0x0;
      --  unspecified
...
--        B_0x3 => 3);
   ...
   subtype RCC_CFGR_SWS1_Field is Boolean;

   type RCC_CFGR_SWS_Field_Array is array (0 .. 1) of RCC_CFGR_SWS1_Field
     with Component_Size => 1, Size => 2;

   --  Type definition for RCC_CFGR_SWS
...
--        B_0xF => 15);
   subtype RCC_CFGR_HPRE_Field is HAL.UInt4
      with Static_Predicate => RCC_CFGR_HPRE_Field in 0 | 8 .. 15;
...
--        B_0x7 => 7);
   ...
   type RCC_CFGR_Register is record
      ...
      --  Reserved Note: This clock output may have some truncated cycles at
      --  startup or during MCO clock source switching.
      MCOSEL         : RCC_CFGR_MCOSEL_Field := STM32_SVD.RCC.B_0x0;
      ...
      MCOPRE         : RCC_CFGR_MCOPRE_Field := STM32_SVD.RCC.B_0x0;
      --  unspecified
      Reserved_31_31 : Boolean := False;
   end record
     with Volatile_Full_Access, Object_Size => 32,
...
--        B_0xF => 15);
   ...
   type RCC_PLLCFGR_PLLN_Field_Base is range 0 .. 127
      with Size => 8;
   subtype RCC_PLLCFGR_PLLN_Field is RCC_PLLCFGR_PLLN_Field_Base
      with Static_Predicate => RCC_PLLCFGR_PLLN_Field in 0 | 1 | 7 .. 9 | 16 | 127;
...
--        B_0x1 => 1);
   ...
   subtype RCC_PLLCFGR_PLLQ_Field is HAL.UInt2;
--       (--  PLLQ = 2
--        B_0x0,
--        --  PLLQ = 4
--        B_0x1,
...
--        B_0x3 => 3);
   ...
   type RCC_PLLCFGR_Register is record
      ...
      PLLN           : RCC_PLLCFGR_PLLN_Field := 10#16#;
      --  unspecified
      ...
      --  PLLPEN should be 0.
      PLLPEN         : RCC_PLLCFGR_PLLPEN_Field := STM32_SVD.RCC.B_0x0;
      ...
      --  be 0.
      PLLQEN         : RCC_PLLCFGR_PLLQEN_Field := STM32_SVD.RCC.B_0x0;
      ...
      PLLREN         : RCC_PLLCFGR_PLLREN_Field := STM32_SVD.RCC.B_0x0;
      ...
      PLLR           : RCC_PLLCFGR_PLLR_Field := STM32_SVD.RCC.B_0x0;
      ...
      --  PLLPDIV. ....
      PLLPDIV        : RCC_PLLCFGR_PLLPDIV_Field := STM32_SVD.RCC.B_0x0;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type RCC_CIER_Register is record
      ...
      LSIRDYIE       : RCC_CIER_LSIRDYIE_Field := STM32_SVD.RCC.B_0x0;
      ...
      LSERDYIE       : RCC_CIER_LSERDYIE_Field := STM32_SVD.RCC.B_0x0;
      --  unspecified
      Reserved_2_2   : Boolean := False;
      --  HSI16 ready interrupt enable Set and cleared by software to
      --  enable/disable interrupt caused by the HSI16 oscillator
      --  stabilization.
      HSIRDYIE       : RCC_CIER_HSIRDYIE_Field := STM32_SVD.RCC.B_0x0;
      ...
      HSERDYIE       : RCC_CIER_HSERDYIE_Field := STM32_SVD.RCC.B_0x0;
      --  PLL ready interrupt enable Set and cleared by software to
      --  enable/disable interrupt caused by PLL lock.
      PLLRDYIE       : RCC_CIER_PLLRDYIE_Field := STM32_SVD.RCC.B_0x0;
      --  unspecified
      ...
      --  system on LSE.
      LSECSSIE       : RCC_CIER_LSECSSIE_Field := STM32_SVD.RCC.B_0x0;
      --  HSI48 ready interrupt enable Set and cleared by software to
      --  enable/disable interrupt caused by the internal HSI48 oscillator.
      HSI48RDYIE     : RCC_CIER_HSI48RDYIE_Field := STM32_SVD.RCC.B_0x0;
      --  unspecified
   ...
   subtype RCC_AHB1RSTR_DMA1RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset DMA1
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB1RSTR_DMA2RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset DMA2
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB1RSTR_DMAMUX1RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset DMAMUX1
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   --  Set and cleared by software
   subtype RCC_AHB1RSTR_CORDICRST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset CORDIC
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   --  Set and cleared by software
   subtype RCC_AHB1RSTR_FMACRST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset FMAC
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB1RSTR_FLASHRST_Field is Boolean;
--       (--  No effect
--        B_0x0,
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB1RSTR_CRCRST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset CRC
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   type RCC_AHB1RSTR_Register is record
      --  DMA1 reset Set and cleared by software.
      DMA1RST        : RCC_AHB1RSTR_DMA1RST_Field := False;
      --  DMA2 reset Set and cleared by software.
      DMA2RST        : RCC_AHB1RSTR_DMA2RST_Field := False;
      --  Set and cleared by software.
      DMAMUX1RST     : RCC_AHB1RSTR_DMAMUX1RST_Field := False;
      --  Set and cleared by software
      CORDICRST      : RCC_AHB1RSTR_CORDICRST_Field := False;
      --  Set and cleared by software
      FMACRST        : RCC_AHB1RSTR_FMACRST_Field := False;
      --  unspecified
      ...
      FLASHRST       : RCC_AHB1RSTR_FLASHRST_Field := False;
      --  unspecified
      Reserved_9_11  : HAL.UInt3 := 16#0#;
      --  CRC reset Set and cleared by software.
      CRCRST         : RCC_AHB1RSTR_CRCRST_Field := False;
      --  unspecified
   ...
   subtype RCC_AHB2RSTR_GPIOARST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset IO port A
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2RSTR_GPIOBRST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset IO port B
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2RSTR_GPIOCRST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset IO port C
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2RSTR_GPIODRST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset IO port D
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2RSTR_GPIOERST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset IO port E
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2RSTR_GPIOFRST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset IO port F
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2RSTR_GPIOGRST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset IO port G
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2RSTR_ADC12RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2RSTR_ADC345RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset ADC345
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2RSTR_DAC1RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset DAC1
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2RSTR_DAC2RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset DAC2
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2RSTR_DAC3RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset DAC3
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2RSTR_DAC4RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset DAC4
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2RSTR_AESRST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset AES
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2RSTR_RNGRST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset RNG
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   type RCC_AHB2RSTR_Register is record
      --  IO port A reset Set and cleared by software.
      GPIOARST       : RCC_AHB2RSTR_GPIOARST_Field := False;
      --  IO port B reset Set and cleared by software.
      GPIOBRST       : RCC_AHB2RSTR_GPIOBRST_Field := False;
      --  IO port C reset Set and cleared by software.
      GPIOCRST       : RCC_AHB2RSTR_GPIOCRST_Field := False;
      --  IO port D reset Set and cleared by software.
      GPIODRST       : RCC_AHB2RSTR_GPIODRST_Field := False;
      --  IO port E reset Set and cleared by software.
      GPIOERST       : RCC_AHB2RSTR_GPIOERST_Field := False;
      --  IO port F reset Set and cleared by software.
      GPIOFRST       : RCC_AHB2RSTR_GPIOFRST_Field := False;
      --  IO port G reset Set and cleared by software.
      GPIOGRST       : RCC_AHB2RSTR_GPIOGRST_Field := False;
      --  unspecified
      Reserved_7_12  : HAL.UInt6 := 16#0#;
      --  ADC12 reset Set and cleared by software.
      ADC12RST       : RCC_AHB2RSTR_ADC12RST_Field := False;
      --  ADC345 reset Set and cleared by software.
      ADC345RST      : RCC_AHB2RSTR_ADC345RST_Field := False;
      --  unspecified
      Reserved_15_15 : Boolean := False;
      --  DAC1 reset Set and cleared by software.
      DAC1RST        : RCC_AHB2RSTR_DAC1RST_Field := False;
      --  DAC2 reset Set and cleared by software.
      DAC2RST        : RCC_AHB2RSTR_DAC2RST_Field := False;
      --  DAC3 reset Set and cleared by software.
      DAC3RST        : RCC_AHB2RSTR_DAC3RST_Field := False;
      --  DAC4 reset Set and cleared by software.
      DAC4RST        : RCC_AHB2RSTR_DAC4RST_Field := False;
      --  unspecified
      Reserved_20_23 : HAL.UInt4 := 16#0#;
      --  AESRST reset Set and cleared by software.
      AESRST         : RCC_AHB2RSTR_AESRST_Field := False;
      --  unspecified
      Reserved_25_25 : Boolean := False;
      --  RNG reset Set and cleared by software.
      RNGRST         : RCC_AHB2RSTR_RNGRST_Field := False;
      --  unspecified
   ...
   type RCC_AHB3RSTR_Register is record
      --  Flexible static memory controller reset Set and cleared by software.
      FMCRST        : RCC_AHB3RSTR_FMCRST_Field := STM32_SVD.RCC.B_0x0;
      --  unspecified
      Reserved_1_7  : HAL.UInt7 := 16#0#;
      --  QUADSPI reset Set and cleared by software.
      QSPIRST       : RCC_AHB3RSTR_QSPIRST_Field := STM32_SVD.RCC.B_0x0;
      --  unspecified
   ...
   subtype RCC_APB1RSTR1_TIM2RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset TIM2
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1RSTR1_TIM3RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset TIM3
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   --  TIM3 timer reset Set and cleared by software.
   subtype RCC_APB1RSTR1_TIM4RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset TIM3
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1RSTR1_TIM5RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset TIM5
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1RSTR1_TIM6RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset TIM7
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1RSTR1_TIM7RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset TIM7
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1RSTR1_CRSRST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset CRS
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1RSTR1_SPI2RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset SPI2
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1RSTR1_SPI3RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset SPI3
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1RSTR1_USART2RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset USART2
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1RSTR1_USART3RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset USART3
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1RSTR1_UART4RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset UART4
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1RSTR1_UART5RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset UART5
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1RSTR1_I2C1RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset I2C1
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1RSTR1_I2C2RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset I2C2
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1RSTR1_USBRST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset USB device
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1RSTR1_FDCANRST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset the FDCAN
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1RSTR1_PWRRST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset PWR
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1RSTR1_I2C3RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1RSTR1_LPTIM1RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset LPTIM1
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   type RCC_APB1RSTR1_Register is record
      --  TIM2 timer reset Set and cleared by software.
      TIM2RST        : RCC_APB1RSTR1_TIM2RST_Field := False;
      --  TIM3 timer reset Set and cleared by software.
      TIM3RST        : RCC_APB1RSTR1_TIM3RST_Field := False;
      --  TIM3 timer reset Set and cleared by software.
      TIM4RST        : RCC_APB1RSTR1_TIM4RST_Field := False;
      --  TIM5 timer reset Set and cleared by software.
      TIM5RST        : RCC_APB1RSTR1_TIM5RST_Field := False;
      --  TIM6 timer reset Set and cleared by software.
      TIM6RST        : RCC_APB1RSTR1_TIM6RST_Field := False;
      --  TIM7 timer reset Set and cleared by software.
      TIM7RST        : RCC_APB1RSTR1_TIM7RST_Field := False;
      --  unspecified
      Reserved_6_7   : HAL.UInt2 := 16#0#;
      --  CRS reset Set and cleared by software.
      CRSRST         : RCC_APB1RSTR1_CRSRST_Field := False;
      --  unspecified
      Reserved_9_13  : HAL.UInt5 := 16#0#;
      --  SPI2 reset Set and cleared by software.
      SPI2RST        : RCC_APB1RSTR1_SPI2RST_Field := False;
      --  SPI3 reset Set and cleared by software.
      SPI3RST        : RCC_APB1RSTR1_SPI3RST_Field := False;
      --  unspecified
      Reserved_16_16 : Boolean := False;
      --  USART2 reset Set and cleared by software.
      USART2RST      : RCC_APB1RSTR1_USART2RST_Field := False;
      --  USART3 reset Set and cleared by software.
      USART3RST      : RCC_APB1RSTR1_USART3RST_Field := False;
      --  UART4 reset Set and cleared by software.
      UART4RST       : RCC_APB1RSTR1_UART4RST_Field := False;
      --  UART5 reset Set and cleared by software.
      UART5RST       : RCC_APB1RSTR1_UART5RST_Field := False;
      --  I2C1 reset Set and cleared by software.
      I2C1RST        : RCC_APB1RSTR1_I2C1RST_Field := False;
      --  I2C2 reset Set and cleared by software.
      I2C2RST        : RCC_APB1RSTR1_I2C2RST_Field := False;
      --  USB device reset Set and reset by software.
      USBRST         : RCC_APB1RSTR1_USBRST_Field := False;
      --  unspecified
      Reserved_24_24 : Boolean := False;
      --  FDCAN reset Set and reset by software.
      FDCANRST       : RCC_APB1RSTR1_FDCANRST_Field := False;
      --  unspecified
      Reserved_26_27 : HAL.UInt2 := 16#0#;
      --  Power interface reset Set and cleared by software.
      PWRRST         : RCC_APB1RSTR1_PWRRST_Field := False;
      --  unspecified
      Reserved_29_29 : Boolean := False;
      --  I2C3 reset Set and cleared by software.
      I2C3RST        : RCC_APB1RSTR1_I2C3RST_Field := False;
      --  Low Power Timer 1 reset Set and cleared by software.
      LPTIM1RST      : RCC_APB1RSTR1_LPTIM1RST_Field := False;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
...
--        B_0x1 => 1);
   ...
   type RCC_APB1RSTR2_Register is record
      ...
      --  UCPD1 reset Set and cleared by software.
      UCPD1RST      : RCC_APB1RSTR2_UCPD1RST_Field := STM32_SVD.RCC.B_0x0;
      --  unspecified
      Reserved_9_31 : HAL.UInt23 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype RCC_APB2RSTR_SYSCFGRST_Field is Boolean;
--       (--  No effect
--        B_0x0,
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB2RSTR_TIM1RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset TIM1 timer
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB2RSTR_SPI1RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset SPI1
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB2RSTR_TIM8RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset TIM8 timer
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB2RSTR_USART1RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset USART1
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB2RSTR_SPI4RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset SPI4
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB2RSTR_TIM15RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset TIM15 timer
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB2RSTR_TIM16RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset TIM16 timer
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB2RSTR_TIM17RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset TIM17 timer
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB2RSTR_TIM20RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset TIM20
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB2RSTR_SAI1RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset SAI1
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB2RSTR_HRTIM1RST_Field is Boolean;
--       (--  No effect
--        B_0x0,
--        --  Reset HRTIM1
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   type RCC_APB2RSTR_Register is record
      --  SYSCFG + COMP + OPAMP + VREFBUF reset
      SYSCFGRST      : RCC_APB2RSTR_SYSCFGRST_Field := False;
      --  unspecified
      Reserved_1_10  : HAL.UInt10 := 16#0#;
      --  TIM1 timer reset Set and cleared by software.
      TIM1RST        : RCC_APB2RSTR_TIM1RST_Field := False;
      --  SPI1 reset Set and cleared by software.
      SPI1RST        : RCC_APB2RSTR_SPI1RST_Field := False;
      --  TIM8 timer reset Set and cleared by software.
      TIM8RST        : RCC_APB2RSTR_TIM8RST_Field := False;
      --  USART1 reset Set and cleared by software.
      USART1RST      : RCC_APB2RSTR_USART1RST_Field := False;
      --  SPI4 reset Set and cleared by software.
      SPI4RST        : RCC_APB2RSTR_SPI4RST_Field := False;
      --  TIM15 timer reset Set and cleared by software.
      TIM15RST       : RCC_APB2RSTR_TIM15RST_Field := False;
      --  TIM16 timer reset Set and cleared by software.
      TIM16RST       : RCC_APB2RSTR_TIM16RST_Field := False;
      --  TIM17 timer reset Set and cleared by software.
      TIM17RST       : RCC_APB2RSTR_TIM17RST_Field := False;
      --  unspecified
      Reserved_19_19 : Boolean := False;
      --  TIM20 reset Set and cleared by software.
      TIM20RST       : RCC_APB2RSTR_TIM20RST_Field := False;
      --  Serial audio interface 1 (SAI1) reset Set and cleared by software.
      SAI1RST        : RCC_APB2RSTR_SAI1RST_Field := False;
      --  unspecified
      Reserved_22_25 : HAL.UInt4 := 16#0#;
      --  HRTIM1 reset Set and cleared by software.
      HRTIM1RST      : RCC_APB2RSTR_HRTIM1RST_Field := False;
      --  unspecified
      Reserved_27_31 : HAL.UInt5 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype RCC_AHB1ENR_DMA1EN_Field is Boolean;
--       (--  DMA1 clock disable
--        B_0x0,
--        --  DMA1 clock enable
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB1ENR_DMA2EN_Field is Boolean;
--       (--  DMA2 clock disable
--        B_0x0,
--        --  DMA2 clock enable
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB1ENR_DMAMUX1EN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB1ENR_CORDICEN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB1ENR_FMACEN_Field is Boolean;
--       (--  FMAC clock disabled
--        B_0x0,
--        --  FMAC clock enabled
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB1ENR_FLASHEN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB1ENR_CRCEN_Field is Boolean;
--       (--  CRC clock disable
--        B_0x0,
--        --  CRC clock enable
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   type RCC_AHB1ENR_Register is record
      --  DMA1 clock enable Set and cleared by software.
      DMA1EN         : RCC_AHB1ENR_DMA1EN_Field := False;
      --  DMA2 clock enable Set and cleared by software.
      DMA2EN         : RCC_AHB1ENR_DMA2EN_Field := False;
      --  DMAMUX1 clock enable Set and reset by software.
      DMAMUX1EN      : RCC_AHB1ENR_DMAMUX1EN_Field := False;
      --  CORDIC clock enable Set and reset by software.
      CORDICEN       : RCC_AHB1ENR_CORDICEN_Field := False;
      --  FMAC enable Set and reset by software.
      FMACEN         : RCC_AHB1ENR_FMACEN_Field := False;
      --  unspecified
      Reserved_5_7   : HAL.UInt3 := 16#0#;
      --  Flash memory interface clock enable Set and cleared by software. This
      --  bit can be disabled only when the Flash is in power down mode.
      FLASHEN        : RCC_AHB1ENR_FLASHEN_Field := True;
      --  unspecified
      Reserved_9_11  : HAL.UInt3 := 16#0#;
      --  CRC clock enable Set and cleared by software.
      CRCEN          : RCC_AHB1ENR_CRCEN_Field := False;
      --  unspecified
      Reserved_13_31 : HAL.UInt19 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype RCC_AHB2ENR_GPIOAEN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2ENR_GPIOBEN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2ENR_GPIOCEN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2ENR_GPIODEN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2ENR_GPIOEEN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2ENR_GPIOFEN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2ENR_GPIOGEN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2ENR_ADC12EN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2ENR_ADC345EN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2ENR_DAC1EN_Field is Boolean;
--       (--  DAC1 clock disabled
--        B_0x0,
--        --  DAC1 clock enabled
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2ENR_DAC2EN_Field is Boolean;
--       (--  DAC2 clock disabled
--        B_0x0,
--        --  DAC2 clock enabled
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2ENR_DAC3EN_Field is Boolean;
--       (--  DAC3 clock disabled
--        B_0x0,
--        --  DAC3 clock enabled
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2ENR_DAC4EN_Field is Boolean;
--       (--  DAC4 clock disabled
--        B_0x0,
--        --  DAC4 clock enabled
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2ENR_AESEN_Field is Boolean;
--       (--  AES clock disabled
--        B_0x0,
--        --  AES clock enabled
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB2ENR_RNGEN_Field is Boolean;
--       (--  RNG disabled
--        B_0x0,
--        --  RNG enabled
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   type RCC_AHB2ENR_Register is record
      --  IO port A clock enable Set and cleared by software.
      GPIOAEN        : RCC_AHB2ENR_GPIOAEN_Field := False;
      --  IO port B clock enable Set and cleared by software.
      GPIOBEN        : RCC_AHB2ENR_GPIOBEN_Field := False;
      --  IO port C clock enable Set and cleared by software.
      GPIOCEN        : RCC_AHB2ENR_GPIOCEN_Field := False;
      --  IO port D clock enable Set and cleared by software.
      GPIODEN        : RCC_AHB2ENR_GPIODEN_Field := False;
      --  IO port E clock enable Set and cleared by software.
      GPIOEEN        : RCC_AHB2ENR_GPIOEEN_Field := False;
      --  IO port F clock enable Set and cleared by software.
      GPIOFEN        : RCC_AHB2ENR_GPIOFEN_Field := False;
      --  IO port G clock enable Set and cleared by software.
      GPIOGEN        : RCC_AHB2ENR_GPIOGEN_Field := False;
      --  unspecified
      Reserved_7_12  : HAL.UInt6 := 16#0#;
      --  ADC12 clock enable Set and cleared by software.
      ADC12EN        : RCC_AHB2ENR_ADC12EN_Field := False;
      --  ADC345 clock enable Set and cleared by software
      ADC345EN       : RCC_AHB2ENR_ADC345EN_Field := False;
      --  unspecified
      Reserved_15_15 : Boolean := False;
      --  DAC1 clock enable Set and cleared by software.
      DAC1EN         : RCC_AHB2ENR_DAC1EN_Field := False;
      --  DAC2 clock enable Set and cleared by software.
      DAC2EN         : RCC_AHB2ENR_DAC2EN_Field := False;
      --  DAC3 clock enable Set and cleared by software.
      DAC3EN         : RCC_AHB2ENR_DAC3EN_Field := False;
      --  DAC4 clock enable Set and cleared by software.
      DAC4EN         : RCC_AHB2ENR_DAC4EN_Field := False;
      --  unspecified
      Reserved_20_23 : HAL.UInt4 := 16#0#;
      --  AES clock enable Set and cleared by software.
      AESEN          : RCC_AHB2ENR_AESEN_Field := False;
      --  unspecified
      Reserved_25_25 : Boolean := False;
      --  RNG enable Set and cleared by software.
      RNGEN          : RCC_AHB2ENR_RNGEN_Field := False;
      --  unspecified
      Reserved_27_31 : HAL.UInt5 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   --  software.
   subtype RCC_AHB3ENR_FMCEN_Field is Boolean;
--       (--  FSMC clock disable
--        B_0x0,
--        --  FSMC clock enable
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB3ENR_QSPIEN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   type RCC_AHB3ENR_Register is record
      --  Flexible static memory controller clock enable Set and cleared by
      --  software.
      FMCEN         : RCC_AHB3ENR_FMCEN_Field := False;
      --  unspecified
      Reserved_1_7  : HAL.UInt7 := 16#0#;
      --  QUADSPI memory interface clock enable Set and cleared by software.
      QSPIEN        : RCC_AHB3ENR_QSPIEN_Field := False;
      --  unspecified
      Reserved_9_31 : HAL.UInt23 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype RCC_APB1ENR1_TIM2EN_Field is Boolean;
--       (--  TIM2 clock disabled
--        B_0x0,
--        --  TIM2 clock enabled
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1ENR1_TIM3EN_Field is Boolean;
--       (--  TIM3 clock disabled
--        B_0x0,
--        --  TIM3 clock enabled
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1ENR1_TIM4EN_Field is Boolean;
--       (--  TIM4 clock disabled
--        B_0x0,
--        --  TIM4 clock enabled
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1ENR1_TIM5EN_Field is Boolean;
--       (--  TIM5 clock disabled
--        B_0x0,
--        --  TIM5 clock enabled
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1ENR1_TIM6EN_Field is Boolean;
--       (--  TIM6 clock disabled
--        B_0x0,
--        --  TIM6 clock enabled
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1ENR1_TIM7EN_Field is Boolean;
--       (--  TIM7 clock disabled
--        B_0x0,
--        --  TIM7 clock enabled
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1ENR1_CRSEN_Field is Boolean;
--       (--  CRS clock disabled
--        B_0x0,
--        --  CRS clock enabled
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1ENR1_RTCAPBEN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1ENR1_WWDGEN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1ENR1_SPI2EN_Field is Boolean;
--       (--  SPI2 clock disabled
--        B_0x0,
--        --  SPI2 clock enabled
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1ENR1_SPI3EN_Field is Boolean;
--       (--  SPI3 clock disabled
--        B_0x0,
--        --  SPI3 clock enabled
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1ENR1_USART2EN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1ENR1_USART3EN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1ENR1_UART4EN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1ENR1_UART5EN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1ENR1_I2C1EN_Field is Boolean;
--       (--  I2C1 clock disabled
--        B_0x0,
--        --  I2C1 clock enabled
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1ENR1_I2C2EN_Field is Boolean;
--       (--  I2C2 clock disabled
--        B_0x0,
--        --  I2C2 clock enabled
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1ENR1_USBEN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1ENR1_FDCANEN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1ENR1_PWREN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1ENR1_I2C3EN_Field is Boolean;
--       (--  I2C3 clock disabled
--        B_0x0,
--        --  I2C3 clock enabled
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1ENR1_LPTIM1EN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   type RCC_APB1ENR1_Register is record
      --  TIM2 timer clock enable Set and cleared by software.
      TIM2EN         : RCC_APB1ENR1_TIM2EN_Field := False;
      --  TIM3 timer clock enable Set and cleared by software.
      TIM3EN         : RCC_APB1ENR1_TIM3EN_Field := False;
      --  TIM4 timer clock enable Set and cleared by software.
      TIM4EN         : RCC_APB1ENR1_TIM4EN_Field := False;
      --  TIM5 timer clock enable Set and cleared by software.
      TIM5EN         : RCC_APB1ENR1_TIM5EN_Field := False;
      --  TIM6 timer clock enable Set and cleared by software.
      TIM6EN         : RCC_APB1ENR1_TIM6EN_Field := False;
      --  TIM7 timer clock enable Set and cleared by software.
      TIM7EN         : RCC_APB1ENR1_TIM7EN_Field := False;
      --  unspecified
      Reserved_6_7   : HAL.UInt2 := 16#0#;
      --  CRS Recovery System clock enable Set and cleared by software.
      CRSEN          : RCC_APB1ENR1_CRSEN_Field := False;
      --  unspecified
      Reserved_9_9   : Boolean := False;
      --  RTC APB clock enable Set and cleared by software
      RTCAPBEN       : RCC_APB1ENR1_RTCAPBEN_Field := True;
      --  Window watchdog clock enable Set by software to enable the window
      --  watchdog clock. Reset by hardware system reset. This bit can also be
      --  set by hardware if the WWDG_SW option bit is reset.
      WWDGEN         : RCC_APB1ENR1_WWDGEN_Field := False;
      --  unspecified
      Reserved_12_13 : HAL.UInt2 := 16#0#;
      --  SPI2 clock enable Set and cleared by software.
      SPI2EN         : RCC_APB1ENR1_SPI2EN_Field := False;
      --  SPI3 clock enable Set and cleared by software.
      SPI3EN         : RCC_APB1ENR1_SPI3EN_Field := False;
      --  unspecified
      Reserved_16_16 : Boolean := False;
      --  USART2 clock enable Set and cleared by software.
      USART2EN       : RCC_APB1ENR1_USART2EN_Field := False;
      --  USART3 clock enable Set and cleared by software.
      USART3EN       : RCC_APB1ENR1_USART3EN_Field := False;
      --  UART4 clock enable Set and cleared by software.
      UART4EN        : RCC_APB1ENR1_UART4EN_Field := False;
      --  UART5 clock enable Set and cleared by software.
      UART5EN        : RCC_APB1ENR1_UART5EN_Field := False;
      --  I2C1 clock enable Set and cleared by software.
      I2C1EN         : RCC_APB1ENR1_I2C1EN_Field := False;
      --  I2C2 clock enable Set and cleared by software.
      I2C2EN         : RCC_APB1ENR1_I2C2EN_Field := False;
      --  USB device clock enable Set and cleared by software.
      USBEN          : RCC_APB1ENR1_USBEN_Field := False;
      --  unspecified
      Reserved_24_24 : Boolean := False;
      --  FDCAN clock enable Set and cleared by software.
      FDCANEN        : RCC_APB1ENR1_FDCANEN_Field := False;
      --  unspecified
      Reserved_26_27 : HAL.UInt2 := 16#0#;
      --  Power interface clock enable Set and cleared by software.
      PWREN          : RCC_APB1ENR1_PWREN_Field := False;
      --  unspecified
      Reserved_29_29 : Boolean := False;
      --  I2C3 clock enable Set and cleared by software.
      I2C3EN         : RCC_APB1ENR1_I2C3EN_Field := False;
      --  Low power timer 1 clock enable Set and cleared by software.
      LPTIM1EN       : RCC_APB1ENR1_LPTIM1EN_Field := False;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype RCC_APB1ENR2_LPUART1EN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1ENR2_I2C4EN_Field is Boolean;
--       (--  I2C4 clock disabled
--        B_0x0,
--        --  I2C4 clock enabled
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB1ENR2_UCPD1EN_Field is Boolean;
--       (--  UCPD1 clock disable
--        B_0x0,
--        --  UCPD1 clock enable
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   type RCC_APB1ENR2_Register is record
      --  Low power UART 1 clock enable Set and cleared by software.
      LPUART1EN     : RCC_APB1ENR2_LPUART1EN_Field := False;
      --  I2C4 clock enable Set and cleared by software
      I2C4EN        : RCC_APB1ENR2_I2C4EN_Field := False;
      --  unspecified
      Reserved_2_7  : HAL.UInt6 := 16#0#;
      --  UCPD1 clock enable Set and cleared by software.
      UCPD1EN       : RCC_APB1ENR2_UCPD1EN_Field := False;
      --  unspecified
      Reserved_9_31 : HAL.UInt23 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   --  software.
   subtype RCC_APB2ENR_SYSCFGEN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB2ENR_TIM1EN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB2ENR_SPI1EN_Field is Boolean;
--       (--  SPI1 clock disabled
--        B_0x0,
--        --  SPI1 clock enabled
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB2ENR_TIM8EN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB2ENR_USART1EN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB2ENR_SPI4EN_Field is Boolean;
--       (--  SPI4 clock disabled
--        B_0x0,
--        --  SPI4 clock enabled
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB2ENR_TIM15EN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB2ENR_TIM16EN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB2ENR_TIM17EN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB2ENR_TIM20EN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB2ENR_SAI1EN_Field is Boolean;
--       (--  SAI1 clock disabled
--        B_0x0,
--        --  SAI1 clock enabled
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_APB2ENR_HRTIM1EN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   type RCC_APB2ENR_Register is record
      --  SYSCFG + COMP + VREFBUF + OPAMP clock enable Set and cleared by
      --  software.
      SYSCFGEN       : RCC_APB2ENR_SYSCFGEN_Field := False;
      --  unspecified
      Reserved_1_10  : HAL.UInt10 := 16#0#;
      --  TIM1 timer clock enable Set and cleared by software.
      TIM1EN         : RCC_APB2ENR_TIM1EN_Field := False;
      --  SPI1 clock enable Set and cleared by software.
      SPI1EN         : RCC_APB2ENR_SPI1EN_Field := False;
      --  TIM8 timer clock enable Set and cleared by software.
      TIM8EN         : RCC_APB2ENR_TIM8EN_Field := False;
      --  USART1clock enable Set and cleared by software.
      USART1EN       : RCC_APB2ENR_USART1EN_Field := False;
      --  SPI4 clock enable Set and cleared by software.
      SPI4EN         : RCC_APB2ENR_SPI4EN_Field := False;
      --  TIM15 timer clock enable Set and cleared by software.
      TIM15EN        : RCC_APB2ENR_TIM15EN_Field := False;
      --  TIM16 timer clock enable Set and cleared by software.
      TIM16EN        : RCC_APB2ENR_TIM16EN_Field := False;
      --  TIM17 timer clock enable Set and cleared by software.
      TIM17EN        : RCC_APB2ENR_TIM17EN_Field := False;
      --  unspecified
      Reserved_19_19 : Boolean := False;
      --  TIM20 timer clock enable Set and cleared by software.
      TIM20EN        : RCC_APB2ENR_TIM20EN_Field := False;
      --  SAI1 clock enable Set and cleared by software.
      SAI1EN         : RCC_APB2ENR_SAI1EN_Field := False;
      --  unspecified
      Reserved_22_25 : HAL.UInt4 := 16#0#;
      --  HRTIM1 clock enable Set and cleared by software.
      HRTIM1EN       : RCC_APB2ENR_HRTIM1EN_Field := False;
      --  unspecified
      Reserved_27_31 : HAL.UInt5 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   --  software.
   subtype RCC_AHB1SMENR_DMA1SMEN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB1SMENR_DMA2SMEN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   --  software.
   subtype RCC_AHB1SMENR_DMAMUX1SMEN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB1SMENR_CORDICSMEN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_AHB1SMENR_FMACSMEN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   --  cleared by software.
   subtype RCC_AHB1SMENR_FLASHSMEN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   --  cleared by software.
   subtype RCC_AHB1SMENR_SRAM1SMEN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   --  software.
   subtype RCC_AHB1SMENR_CRCSMEN_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   type RCC_AHB1SMENR_Register is record
      --  DMA1 clocks enable during Sleep and Stop modes Set and cleared by
      --  software.
      DMA1SMEN       : RCC_AHB1SMENR_DMA1SMEN_Field := True;
      --  DMA2 clocks enable during Sleep and Stop modes Set and cleared by
      --  software during Sleep mode.
      DMA2SMEN       : RCC_AHB1SMENR_DMA2SMEN_Field := True;
      --  DMAMUX1 clock enable during Sleep and Stop modes. Set and cleared by
      --  software.
      DMAMUX1SMEN    : RCC_AHB1SMENR_DMAMUX1SMEN_Field := True;
      --  CORDICSM clock enable. Set and cleared by software.
      CORDICSMEN     : RCC_AHB1SMENR_CORDICSMEN_Field := True;
      --  FMACSM clock enable. Set and cleared by software.
      FMACSMEN       : RCC_AHB1SMENR_FMACSMEN_Field := False;
      --  unspecified
      Reserved_5_7   : HAL.UInt3 := 16#0#;
      --  Flash memory interface clocks enable during Sleep and Stop modes Set
      --  and cleared by software.
      FLASHSMEN      : RCC_AHB1SMENR_FLASHSMEN_Field := True;
      --  SRAM1 interface clocks enable during Sleep and Stop modes Set and
      --  cleared by software.
      SRAM1SMEN      : RCC_AHB1SMENR_SRAM1SMEN_Field := True;
      --  unspecified
      Reserved_10_11 : HAL.UInt2 := 16#0#;
      --  CRC clocks enable during Sleep and Stop modes Set and cleared by
      --  software.
      CRCSMEN        : RCC_AHB1SMENR_CRCSMEN_Field := True;
      --  unspecified
      Reserved_13_31 : HAL.UInt19 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
...
--  Stop modes
   ...
   type RCC_AHB2SMENR_Register is record
      ...
      --  by software.
      GPIOASMEN      : RCC_AHB2SMENR_GPIOASMEN_Field := STM32_SVD.RCC.B_0x1;
      --  IO port B clocks enable during Sleep and Stop modes Set and cleared
      --  by software.
      GPIOBSMEN      : RCC_AHB2SMENR_GPIOBSMEN_Field := STM32_SVD.RCC.B_0x1;
      --  IO port C clocks enable during Sleep and Stop modes Set and cleared
      --  by software.
      GPIOCSMEN      : RCC_AHB2SMENR_GPIOCSMEN_Field := STM32_SVD.RCC.B_0x1;
      --  IO port D clocks enable during Sleep and Stop modes Set and cleared
      --  by software.
      GPIODSMEN      : RCC_AHB2SMENR_GPIODSMEN_Field := STM32_SVD.RCC.B_0x1;
      --  IO port E clocks enable during Sleep and Stop modes Set and cleared
      --  by software.
      GPIOESMEN      : RCC_AHB2SMENR_GPIOESMEN_Field := STM32_SVD.RCC.B_0x1;
      --  IO port F clocks enable during Sleep and Stop modes Set and cleared
      --  by software.
      GPIOFSMEN      : RCC_AHB2SMENR_GPIOFSMEN_Field := STM32_SVD.RCC.B_0x1;
      --  IO port G clocks enable during Sleep and Stop modes Set and cleared
      --  by software.
      GPIOGSMEN      : RCC_AHB2SMENR_GPIOGSMEN_Field := STM32_SVD.RCC.B_0x1;
      --  unspecified
      Reserved_7_8   : HAL.UInt2 := 16#0#;
      --  CCM SRAM interface clocks enable during Sleep and Stop modes Set and
      --  cleared by software.
      CCMSRAMSMEN    : RCC_AHB2SMENR_CCMSRAMSMEN_Field := STM32_SVD.RCC.B_0x1;
      --  SRAM2 interface clocks enable during Sleep and Stop modes Set and
      --  cleared by software.
      SRAM2SMEN      : RCC_AHB2SMENR_SRAM2SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  unspecified
      Reserved_11_12 : HAL.UInt2 := 16#0#;
      --  ADC12 clocks enable during Sleep and Stop modes Set and cleared by
      --  software.
      ADC12SMEN      : RCC_AHB2SMENR_ADC12SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  ADC345 clock enable Set and cleared by software.
      ADC345SMEN     : RCC_AHB2SMENR_ADC345SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  unspecified
      Reserved_15_15 : Boolean := False;
      --  DAC1 clock enable Set and cleared by software.
      DAC1SMEN       : RCC_AHB2SMENR_DAC1SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  DAC2 clock enable Set and cleared by software.
      DAC2SMEN       : RCC_AHB2SMENR_DAC2SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  DAC3 clock enable Set and cleared by software.
      DAC3SMEN       : RCC_AHB2SMENR_DAC3SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  DAC4 clock enable Set and cleared by software.
      DAC4SMEN       : RCC_AHB2SMENR_DAC4SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  unspecified
      Reserved_20_23 : HAL.UInt4 := 16#0#;
      --  AESM clocks enable Set and cleared by software.
      AESSMEN        : RCC_AHB2SMENR_AESSMEN_Field := STM32_SVD.RCC.B_0x1;
      --  unspecified
      Reserved_25_25 : Boolean := False;
      --  RNG enable Set and cleared by software.
      RNGEN          : RCC_AHB2SMENR_RNGEN_Field := STM32_SVD.RCC.B_0x1;
      --  unspecified
      Reserved_27_31 : HAL.UInt5 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
...
--  Stop modes
   ...
   type RCC_AHB3SMENR_Register is record
      --  Flexible static memory controller clocks enable during Sleep and Stop
      --  modes Set and cleared by software.
      FMCSMEN       : RCC_AHB3SMENR_FMCSMEN_Field := STM32_SVD.RCC.B_0x1;
      --  unspecified
      Reserved_1_7  : HAL.UInt7 := 16#0#;
      --  QUADSPI memory interface clock enable during Sleep and Stop modes Set
      --  and cleared by software.
      QSPISMEN      : RCC_AHB3SMENR_QSPISMEN_Field := STM32_SVD.RCC.B_0x1;
      --  unspecified
      Reserved_9_31 : HAL.UInt23 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
...
--  Stop modes
   ...
   type RCC_APB1SMENR1_Register is record
      ...
      --  by software.
      TIM2SMEN       : RCC_APB1SMENR1_TIM2SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  TIM3 timer clocks enable during Sleep and Stop modes Set and cleared
      --  by software.
      TIM3SMEN       : RCC_APB1SMENR1_TIM3SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  TIM4 timer clocks enable during Sleep and Stop modes Set and cleared
      --  by software.
      TIM4SMEN       : RCC_APB1SMENR1_TIM4SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  TIM5 timer clocks enable during Sleep and Stop modes Set and cleared
      --  by software.
      TIM5SMEN       : RCC_APB1SMENR1_TIM5SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  TIM6 timer clocks enable during Sleep and Stop modes Set and cleared
      --  by software.
      TIM6SMEN       : RCC_APB1SMENR1_TIM6SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  TIM7 timer clocks enable during Sleep and Stop modes Set and cleared
      --  by software.
      TIM7SMEN       : RCC_APB1SMENR1_TIM7SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  unspecified
      Reserved_6_7   : HAL.UInt2 := 16#0#;
      --  CRS timer clocks enable during Sleep and Stop modes Set and cleared
      --  by software.
      CRSSMEN        : RCC_APB1SMENR1_CRSSMEN_Field := STM32_SVD.RCC.B_0x1;
      --  unspecified
      Reserved_9_9   : Boolean := False;
      --  RTC APB clock enable during Sleep and Stop modes Set and cleared by
      --  software
      RTCAPBSMEN     : RCC_APB1SMENR1_RTCAPBSMEN_Field := STM32_SVD.RCC.B_0x1;
      --  Window watchdog clocks enable during Sleep and Stop modes Set and
      --  cleared by software. This bit is forced to 1 by hardware when the
      --  hardware WWDG option is activated.
      WWDGSMEN       : RCC_APB1SMENR1_WWDGSMEN_Field := STM32_SVD.RCC.B_0x1;
      --  unspecified
      Reserved_12_13 : HAL.UInt2 := 16#0#;
      --  SPI2 clocks enable during Sleep and Stop modes Set and cleared by
      --  software.
      SPI2SMEN       : RCC_APB1SMENR1_SPI2SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  SPI3 clocks enable during Sleep and Stop modes Set and cleared by
      --  software.
      SPI3SMEN       : RCC_APB1SMENR1_SPI3SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  unspecified
      Reserved_16_16 : Boolean := False;
      --  USART2 clocks enable during Sleep and Stop modes Set and cleared by
      --  software.
      USART2SMEN     : RCC_APB1SMENR1_USART2SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  USART3 clocks enable during Sleep and Stop modes Set and cleared by
      --  software.
      USART3SMEN     : RCC_APB1SMENR1_USART3SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  UART4 clocks enable during Sleep and Stop modes Set and cleared by
      --  software.
      UART4SMEN      : RCC_APB1SMENR1_UART4SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  UART5 clocks enable during Sleep and Stop modes Set and cleared by
      --  software.
      UART5SMEN      : RCC_APB1SMENR1_UART5SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  I2C1 clocks enable during Sleep and Stop modes Set and cleared by
      --  software.
      I2C1SMEN       : RCC_APB1SMENR1_I2C1SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  I2C2 clocks enable during Sleep and Stop modes Set and cleared by
      --  software.
      I2C2SMEN       : RCC_APB1SMENR1_I2C2SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  USB device clocks enable during Sleep and Stop modes Set and cleared
      --  by software.
      USBSMEN        : RCC_APB1SMENR1_USBSMEN_Field := STM32_SVD.RCC.B_0x1;
      --  unspecified
      Reserved_24_24 : Boolean := False;
      --  FDCAN clocks enable during Sleep and Stop modes Set and cleared by
      --  software.
      FDCANSMEN      : RCC_APB1SMENR1_FDCANSMEN_Field := STM32_SVD.RCC.B_0x1;
      --  unspecified
      Reserved_26_27 : HAL.UInt2 := 16#0#;
      --  Power interface clocks enable during Sleep and Stop modes Set and
      --  cleared by software.
      PWRSMEN        : RCC_APB1SMENR1_PWRSMEN_Field := STM32_SVD.RCC.B_0x1;
      --  unspecified
      Reserved_29_29 : Boolean := False;
      --  I2C3 clocks enable during Sleep and Stop modes Set and cleared by
      --  software.
      I2C3SMEN       : RCC_APB1SMENR1_I2C3SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  Low power timer 1 clocks enable during Sleep and Stop modes Set and
      --  cleared by software.
      LPTIM1SMEN     : RCC_APB1SMENR1_LPTIM1SMEN_Field := STM32_SVD.RCC.B_0x1;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
...
--  Stop modes
   ...
   type RCC_APB1SMENR2_Register is record
      --  Low power UART 1 clocks enable during Sleep and Stop modes Set and
      --  cleared by software.
      LPUART1SMEN   : RCC_APB1SMENR2_LPUART1SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  I2C4 clocks enable during Sleep and Stop modes Set and cleared by
      --  software
      I2C4SMEN      : RCC_APB1SMENR2_I2C4SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  unspecified
      Reserved_2_7  : HAL.UInt6 := 16#0#;
      --  UCPD1 clocks enable during Sleep and Stop modes Set and cleared by
      --  software.
      UCPD1SMEN     : RCC_APB1SMENR2_UCPD1SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  unspecified
      Reserved_9_31 : HAL.UInt23 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
...
--  Stop modes
   ...
   type RCC_APB2SMENR_Register is record
      --  SYSCFG + COMP + VREFBUF + OPAMP clocks enable during Sleep and Stop
      --  modes Set and cleared by software.
      SYSCFGSMEN     : RCC_APB2SMENR_SYSCFGSMEN_Field := STM32_SVD.RCC.B_0x1;
      --  unspecified
      Reserved_1_10  : HAL.UInt10 := 16#0#;
      --  TIM1 timer clocks enable during Sleep and Stop modes Set and cleared
      --  by software.
      TIM1SMEN       : RCC_APB2SMENR_TIM1SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  SPI1 clocks enable during Sleep and Stop modes Set and cleared by
      --  software.
      SPI1SMEN       : RCC_APB2SMENR_SPI1SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  TIM8 timer clocks enable during Sleep and Stop modes Set and cleared
      --  by software.
      TIM8SMEN       : RCC_APB2SMENR_TIM8SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  USART1clocks enable during Sleep and Stop modes Set and cleared by
      --  software.
      USART1SMEN     : RCC_APB2SMENR_USART1SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  SPI4 timer clocks enable during Sleep and Stop modes Set and cleared
      --  by software.
      SPI4SMEN       : RCC_APB2SMENR_SPI4SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  TIM15 timer clocks enable during Sleep and Stop modes Set and cleared
      --  by software.
      TIM15SMEN      : RCC_APB2SMENR_TIM15SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  TIM16 timer clocks enable during Sleep and Stop modes Set and cleared
      --  by software.
      TIM16SMEN      : RCC_APB2SMENR_TIM16SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  TIM17 timer clocks enable during Sleep and Stop modes Set and cleared
      --  by software.
      TIM17SMEN      : RCC_APB2SMENR_TIM17SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  unspecified
      Reserved_19_19 : Boolean := False;
      --  TIM20 timer clocks enable during Sleep and Stop modes Set and cleared
      --  by software.
      TIM20SMEN      : RCC_APB2SMENR_TIM20SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  SAI1 clocks enable during Sleep and Stop modes Set and cleared by
      --  software.
      SAI1SMEN       : RCC_APB2SMENR_SAI1SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  unspecified
      Reserved_22_25 : HAL.UInt4 := 16#0#;
      --  HRTIM1 timer clocks enable during Sleep and Stop modes Set and
      --  cleared by software.
      HRTIM1SMEN     : RCC_APB2SMENR_HRTIM1SMEN_Field := STM32_SVD.RCC.B_0x1;
      --  unspecified
      Reserved_27_31 : HAL.UInt5 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype RCC_CCIPR_I2S23SEL_Field is HAL.UInt2;
...
--        B_0x3 => 3);
   ...
   type RCC_CCIPR_Register is record
      ...
      --  RNG.
      CLK48SEL   : RCC_CCIPR_CLK48SEL_Field := STM32_SVD.RCC.B_0x0;
      ...
      ADC12SEL   : RCC_CCIPR_ADC12SEL_Field := STM32_SVD.RCC.B_0x0;
      --  ADC3/4/5 clock source selection These bits are set and cleared by
      --  software to select the clock source used by the ADC345 interface.
      ADC345SEL  : RCC_CCIPR_ADC345SEL_Field := STM32_SVD.RCC.B_0x0;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
...
--        B_0x3 => 3);
   ...
   subtype RCC_BDCR_RTCEN_Field is Boolean;
--       (--  RTC clock disabled
--        B_0x0,
--        --  RTC clock enabled
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   type RCC_BDCR_Register is record
      --  LSE oscillator enable Set and cleared by software.
      LSEON          : RCC_BDCR_LSEON_Field := STM32_SVD.RCC.B_0x0;
      ...
      LSERDY         : RCC_BDCR_LSERDY_Field := STM32_SVD.RCC.B_0x0;
      ...
      LSEBYP         : RCC_BDCR_LSEBYP_Field := STM32_SVD.RCC.B_0x0;
      --  LSE oscillator drive capability Set by software to modulate the LSE
      --  oscillators drive capability. The oscillator is in Xtal mode when it
      --  is not in bypass mode.
      LSEDRV         : RCC_BDCR_LSEDRV_Field := STM32_SVD.RCC.B_0x0;
      ...
      LSECSSON       : RCC_BDCR_LSECSSON_Field := STM32_SVD.RCC.B_0x0;
      ...
      LSECSSD        : RCC_BDCR_LSECSSD_Field := STM32_SVD.RCC.B_0x0;
      --  unspecified
      ...
      --  RTC clock enable Set and cleared by software.
      RTCEN          : RCC_BDCR_RTCEN_Field := False;
      --  RTC domain software reset Set and cleared by software.
      BDRST          : RCC_BDCR_BDRST_Field := STM32_SVD.RCC.B_0x0;
      --  unspecified
      Reserved_17_23 : HAL.UInt7 := 16#0#;
      --  Low speed clock output enable Set and cleared by software.
      LSCOEN         : RCC_BDCR_LSCOEN_Field := STM32_SVD.RCC.B_0x0;
      --  Low speed clock output selection Set and cleared by software.
      LSCOSEL        : RCC_BDCR_LSCOSEL_Field := STM32_SVD.RCC.B_0x0;
      --  unspecified
      Reserved_26_31 : HAL.UInt6 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype RCC_CSR_LSION_Field is Boolean;
--       (--  LSI oscillator OFF
--        B_0x0,
--        --  LSI oscillator ON
--        B_0x1)
...
--        B_0x1 => 1);
   ...
   subtype RCC_CSR_LSIRDY_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   subtype RCC_CSR_RMVF_Field is Boolean;
--       (--  No effect
--        B_0x0,
...
--        B_0x1 => 1);
   ...
   subtype RCC_CSR_WWDGRSTF_Field is Boolean;
...
--        B_0x1 => 1);
   ...
   type RCC_CSR_Register is record
      --  LSI oscillator enable Set and cleared by software.
      LSION          : RCC_CSR_LSION_Field := False;
      ...
      LSIRDY         : RCC_CSR_LSIRDY_Field := False;
      --  unspecified
      Reserved_2_22  : HAL.UInt21 := 16#0#;
      --  Remove reset flag Set by software to clear the reset flags.
      RMVF           : RCC_CSR_RMVF_Field := False;
      --  unspecified
      Reserved_24_24 : Boolean := False;
      ...
      --  to the RMVF bit.
      IWDGRSTF       : RCC_CSR_IWDGRSTF_Field := STM32_SVD.RCC.B_0x0;
      ...
      WWDGRSTF       : RCC_CSR_WWDGRSTF_Field := False;
      ...
      --  writing to the RMVF bit.
      LPWRRSTF       : RCC_CSR_LPWRRSTF_Field := STM32_SVD.RCC.B_0x0;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type RCC_CRRCR_Register is record
      ...
      HSI48ON        : RCC_CRRCR_HSI48ON_Field := STM32_SVD.RCC.B_0x0;
      ...
      HSI48RDY       : RCC_CRRCR_HSI48RDY_Field := STM32_SVD.RCC.B_0x0;
      --  unspecified
   ...
   type RCC_CCIPR2_Register is record
      ...
      I2C4SEL        : RCC_CCIPR2_I2C4SEL_Field := STM32_SVD.RCC.B_0x0;
      --  unspecified
      Reserved_2_19  : HAL.UInt18 := 16#0#;
      --  QUADSPI clock source selection Set and reset by software.
      QSPISEL        : RCC_CCIPR2_QSPISEL_Field := STM32_SVD.RCC.B_0x0;
      --  unspecified
